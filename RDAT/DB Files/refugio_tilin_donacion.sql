...
CREATE TABLE `donacion` (
  ...
  `tipo_donacion` enum('Dinero','Alimento','Medicamento','Otro') NOT NULL,
  `descripcion` text,
  `monto` decimal(10,2) DEFAULT NULL,
  `fecha_donado` date NOT NULL,
...
INSERT INTO `donacion` VALUES (1,1,'Dinero','Donación monetaria para el mantenimiento del refugio',500.00,'2025-09-21');
